...
function AccomodationCreate(props) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                notificationCtx.showNotification({
                    title: "Accomodation",
                    message: "Accomodation stored successfully",
                    status: "success",
                });
    ...
    return (
        <>
            <h1>
                <Link href="/admin-panel/accomodations">Home</Link>
            </h1>
...
export default AccomodationCreate;
